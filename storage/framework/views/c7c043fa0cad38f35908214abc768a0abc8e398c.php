	              ...
	              <form role="form" action="<?php echo e(route('category.update', $category->id)); ?>" method="post">
	                ...
	                <div class="card-body">
		                <div class="form-group">
		                    ...
		                    <input type="text" class="form-control" name="category" id="category" placeholder="Category Title" value="<?php echo e($category->name); ?>">
		                </div>

		                <div class="form-group">
		                	<label for="slug">Category slug</label>
		                    <input type="text" class="form-control" name="slug" id="slug" placeholder="Post Slug" value="<?php echo e($category->slug); ?>">
		                </div>
	                </div>
	                <!-- /.card-body -->
