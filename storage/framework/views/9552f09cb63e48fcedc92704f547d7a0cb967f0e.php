	              ...
	              <form role="form" action="<?php echo e(route('post.update', $post->id)); ?>" method="post">
	                ...
	                <div class="card-body">
		                ...
		                <div class="form-group">
		                    ...
		                    <input type="text" class="form-control" name="subtitle" id="subtitle" placeholder="Sub Title" value="<?php echo e($post->subtitle); ?>">
		                </div>
	                	...
	                	<div class="form-check">
		                    <input type="checkbox" name="status" class="form-check-input" id="exampleCheck1" <?php if($post->ststus == 1): ?> checked  <?php endif; ?>>
